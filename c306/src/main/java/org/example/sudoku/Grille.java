...
public interface Grille {
     ...
     * @return un ElementDeGrille de la grille
     */
     ...
     * Elle renvoi ou null pour 'vider' la case
     *
     ...
     * si l'élément de grille n'est pas autorisé à cette position dans la grille
     ...
     * ou pouvant être mis dans la grille
     ...
     *  renvoi null s'il n'y a pas d'élément à cette position
