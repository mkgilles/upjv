...
/**
 * Méthodes utilitaire permettant de créer une Grille via d'un fichier texte.
        ...
        try (BufferedReader reader =
            ...
            for (int i = 1; i < line.length(); i++) {
                ...
                if (elementDeGrilleMap.containsKey(value)) {
                    throw new IllegalArgumentException("valeur possible "
                            + "dupliquée : " + value);
                }
            ...
            for (int i = 0; i < dimension; i++) {
                ...
                if (line == null || line.length() != dimension) {
                    throw new IOException("pas le bon nombre sur"
                            + "la ligne : " + line);
                }
